...
int main()
{
	...
	*pt |= (AHB1ENR_GPIOAEN | AHB1ENR_GPIODEN);
...
////	GPIOD->ODR |= (LED_LD5_R | LED_LD4_G | LED_LD6_B | LED_LD3_O); // set PD12 thru PD15
...
//	}
	...
	while (1) {
		...
		{
			// Pressed
			GPIOD->BSRR = LED_LD4_G; // Lit green LED
		}
		else
		{
			// Released
			GPIOD->BSRR = (LED_LD4_G<<16); // Dim green LED
		}
